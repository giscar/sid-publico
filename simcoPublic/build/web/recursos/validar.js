...
{   
	...
	{ 	alert ("Debe de escribir el texto de la queja o consulta");
		...
		extensiones_nopermitidas = new Array(".dat",".exe",".bat",".bin",".bmp",".com",".sh",".php",".php3"
			,".php4",".phtml",".py",".js",".pl",".txt"
			,".html",".htm",".msg"); 
 	 ...
 	 if (document.f1.adjunto1.value != "") 
	   ...
	   var input = document.getElementById('adjunto1');
    	   var file = input.files[0];
    	   var fileMb= ((file.size/1024)/1024);
    	  // var posicion =fileMb.indexOf(",") + 2;
    	   //alert(fileMb.substr(0,posicion));
    	   if (fileMb > 20 )
    		{ alert("Su archivo supera el tamaño permitido de 20Mb.");
    		return false; }
	   }
